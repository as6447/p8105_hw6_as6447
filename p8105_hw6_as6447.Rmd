...
```
I Created a city_state variable using a similar process to Homework #5 where I used the `unite` function to combine the city and state variables together and a binary variable indicating whether the homicide is solved. 
